...
function inputValidation(event) {
  ...
  const getInputElement = document.querySelectorAll("#form input[type ='text'] ");
...
function showResult() {
  ...
  const getInterestRate = Number(document.getElementById("interest-rate").value);
  const section = document.querySelector(".section");
      ...
      <h2 class="text-white100 font-semibold text-2xl">Your results</h2>
            ...
            <div class="bg-slate-950 mt-6 border-t-4 border-bgLime rounded-xl">
              <div class="p-8">
                ...
                <h1 class="text-bgLime text-5xl font-medium mt-4">€${monthlyPayment.toFixed(
                  2
                )}</h1>
                <hr class="my-9 border-slate700"/>
                <p class="text-slate300">Total you'll repay over the term</p>
                <h3 class="text-Slate100 mt-3 font-bold">€${totalRepayment.toFixed(2)}</h3>
              </div>
            </div>
      `;
...
// function inputValidation(event){
//     event.preventDefault();
//     const getMortageAmount = document.getElementById("mortgage-amount");
//     const getMortageSpan = document.querySelectorAll(".mortage-span");
//     const getRequiredField = document.querySelector(".required-field");

//     console.log(getMortageSpan);
//     if(!getMortageAmount.value){
//         getMortageAmount.style.border = "1px solid red";
//         getMortageSpan.style.backgroundColor = 'red'
//         getMortageSpan.style.color = "white";
//         getMortageSpan.style.border = "1px solid red";
//         getRequiredField.classList.remove("hidden")
//     }else{
//          getMortageAmount.style.border = "";
//         //  getMortageSpan.style.backgroundColor = "";
//         //  getMortageSpan.style.color = "";
//         //  getMortageSpan.style.border = "";
//          getRequiredField.classList.add("hidden");
//     }
